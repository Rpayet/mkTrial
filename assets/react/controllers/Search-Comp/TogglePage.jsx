    ...
    return(
        <div className="flex gap-2">
            ...
            <button
                ...
                >
                <svg className={`w-8 h-8 ${page == 'sort' ? 'stroke-buttonHoverStroke' : 'stroke-text'} hover:stroke-buttonHoverStroke`}
                    width="800px" 
                    height="800px" 
                    viewBox="0 0 24 24" 
                    fill="none">
            ...
            <button
                ...
                >
                <svg className={`w-8 h-8 ${page == 'create' ? 'stroke-buttonHoverStroke' : 'stroke-text'} hover:stroke-buttonHoverStroke`}
